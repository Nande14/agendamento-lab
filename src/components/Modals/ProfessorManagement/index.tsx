...
const TeacherModal: React.FC<TeacherModalProps> = ({
    ...
    const fetchTeacher = async () => {
      try {
        ...
        const response = await axios.get(
          `https://marcacao-sala.onrender.com/teacher/${teacherId}`,
          {
            headers: {
        ...
        console.error(
          "Ocorreu um erro ao buscar detalhes do professor:",
          error
        );
        setLoading(false);
      }
  ...
  const handleSave = async () => {
    try {
      ...
      setLoading(true);
      await axios.put(
        `https://marcacao-sala.onrender.com/teacher/${teacher.id}`,
        teacher,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      console.error(
        "Ocorreu um erro ao salvar as alterações do professor:",
        error
      );
      setLoading(false);
    }
